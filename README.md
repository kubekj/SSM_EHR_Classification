...
Project no. 24 for 02456 taken at Autumn 2024. The notebook that's supposed to replicate the results (even if it doesn't, as it is explained in the notebook) is `deliverable.ipynb` (we highly encourage to visualize it in a IDE that allows the hiding of the cells' output). 
